...
const ParcoursPage = () => {
  const items = [
    ...
    },
    {
      ...
      url: "",
      cardSubtitle: "Une seconde formation",
      cardDetailedText:
        "Je renforce mes compétences à l'aide des excellents cours de Jonas Schmedtmann (jonas.io), notamment en abordant le fonctionnement interne de JavaScript",
    },
  ];
